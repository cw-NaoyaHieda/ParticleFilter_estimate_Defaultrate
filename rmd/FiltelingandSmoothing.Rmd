...
clusterExport(cl, c("dmvnorm","rmvnorm","A_r","N","g_DR.fn","theta_tau","theta_mu","theta_sigma","proposal_theta_v","runif"))
Sys.time()-start_time
```
こっからは繰り返し
```{r}
...
print(ggplot(plot_d,aes(x=dt))+geom_line(aes(y=answer,colour="answer"))+
        ...
        scale_color_manual(name='',
                           values=c("answer" = "red", "filter" = "blue","sm"="green"))+
        scale_fill_manual(name='',
                          values=c("50%" = "green", "90%" = "gray")))
