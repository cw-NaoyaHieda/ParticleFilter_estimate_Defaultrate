...
set.seed(708)
answer<-AR_sim(time=2,rho = 0.06,PD=0.035)
head(answer)
...
平滑化に関しては、コメント参照
```{r}
colnames(theta_100[[1]]) <- c("n_PD","n_rho")
colnames(theta_100[[2]]) <- c("n_PD","n_rho")
clusterExport(cl, c("theta_100"))
